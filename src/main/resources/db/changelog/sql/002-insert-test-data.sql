...
VALUES ('f0e1ad2c-bdd3-11ed-afa1-0242ac120002', 'Иван', 'Ахматов', '56830149', 'ivan@yandex.ru', 'PARENT', NOW() - 2, NOW() - interval - 0.005);
INSERT INTO Users(id, name, lastname, telegram_id, email,  role, created_when, modified_when)
...
INSERT INTO Family(id, student_id, parent_id, created_when, modified_when)
VALUES ('83d80328-bdda-11ed-afa1-0242ac120002', 'f0e1ad2c-bdd3-11ed-afa1-0242ac120002', 'f0e1ad2c-bdd3-11ed-afa1-0242ac120002', NOW() - 2, NOW());

INSERT INTO Subscription(id, student_id, teacher_id, type, status, start_date, end_date, created_when, modified_when)
VALUES ('a63960e2-bdda-11ed-afa1-0242ac120002', 'f0e1a34a-bdd3-11ed-afa1-0242ac120002', 'f0e1b1be-bdd3-11ed-afa1-0242ac120002', TIME_BASED, NOT_YET_STARTED, NOW() + 1,NOW() + 31, NOW(), NOW());
INSERT INTO Subscription(id, student_id, teacher_id, type, status, start_date, end_date, created_when, modified_when)
VALUES ('a639681c-bdda-11ed-afa1-0242ac120002', 'f0e1a62e-bdd3-11ed-afa1-0242ac120002', 'f0e1b0b0-bdd3-11ed-afa1-0242ac120002', TIME_BASED, CANCELLED, NOW() - 1, NOW() + 364, NOW() - 1, NOW());
INSERT INTO Subscription(id, student_id, teacher_id, type, status, lessons_rest, created_when, modified_when)
VALUES ('a6396a88-bdda-11ed-afa1-0242ac120002', 'f0e1a796-bdd3-11ed-afa1-0242ac120002', 'f0e1b0b0-bdd3-11ed-afa1-0242ac120002', QUANTITY_BASED, ACTIVE, 16, NOW() - 0.15, NOW() - 0.15);
INSERT INTO Subscription(id, student_id, teacher_id, type, status, lessons_rest, created_when, modified_when)
VALUES ('a6396c54-bdda-11ed-afa1-0242ac120002', 'f0e1ad2c-bdd3-11ed-afa1-0242ac120002', 'f0e1b1be-bdd3-11ed-afa1-0242ac120002', QUANTITY_BASED, ACTIVE, 8, NOW() - 0.2, NOW());

INSERT INTO Lesson(id, date, topic, link, status, subscription_id, created_when, modified_when)
VALUES ('6b4e1ec8-bddf-11ed-afa1-0242ac120002', NOW() + 2,'Прошедшее время', 'https://us05web.zoom.us/j', NOT_STARTED_YET, 'a63960e2-bdda-11ed-afa1-0242ac120002',  NOW(), NOW());
INSERT INTO Lesson(id, date, topic, link, status, subscription_id, created_when, modified_when)
VALUES ('6b4e2224-bddf-11ed-afa1-0242ac120002', NOW() + 8,'Будушее время', 'https://us05web.zoom.us/a', NOT_STARTED_YET, 'a63960e2-bdda-11ed-afa1-0242ac120002',  NOW(), NOW());
INSERT INTO Lesson(id, date, topic, link, status, subscription_id, created_when, modified_when)
VALUES ('6b4e23aa-bddf-11ed-afa1-0242ac120002', NOW() - 0.9,'Артикли', 'https://us05web.zoom.us/tt', ENDED, 'a639681c-bdda-11ed-afa1-0242ac120002',  NOW() - 1, NOW() - 0.9);
INSERT INTO Lesson(id, date, topic, link, status, subscription_id, created_when, modified_when)
...
INSERT INTO Lesson(id, date, topic, link, status, subscription_id, created_when, modified_when)
VALUES ('6b4e25b2-bddf-11ed-afa1-0242ac120002', NOW() + 0.04,'Суффиксы', 'https://us05web.zoom.us/mk', NOT_STARTED_YET, 'a6396a88-bdda-11ed-afa1-0242ac120002',  NOW() - 0.15, NOW() - 0.15);
INSERT INTO Lesson(id, date, topic, link, status, subscription_id, created_when, modified_when)
VALUES ('6b4e26c0-bddf-11ed-afa1-0242ac120002', NOW() + 8.04,'Приставки', 'https://us05web.zoom.us/ls', CANCELLED_BY_TEACHER, 'a6396a88-bdda-11ed-afa1-0242ac120002',  NOW() - 0.15, NOW() - 0.1);
INSERT INTO Lesson(id, date, topic, link, status, subscription_id, created_when, modified_when)
...
INSERT INTO Lesson(id, date, topic, link, status, subscription_id, created_when, modified_when)
VALUES ('6b4e29b8-bddf-11ed-afa1-0242ac120002', NOW() + 14,'Чтение', 'https://us05web.zoom.us/ls', CANCELLED_BY_STUDENT, 'a6396a88-bdda-11ed-afa1-0242ac120002',  NOW() - 0.2, NOW() - 0.08);
...
INSERT INTO lesson_info(id, lesson_id, attendance, score, family_comment, teacher_comment, created_when, modified_when)
VALUES ('a1a30abc-bde2-11ed-afa1-0242ac120002', '6b4e23aa-bddf-11ed-afa1-0242ac120002', ATTENDED, 10, 'Отличное занятие. Ребёнок доволен', 'Домашнее задание: стр.24', NOW() - 1, NOW() - 0.9);
INSERT INTO lesson_info(id, lesson_id, attendance, created_when, modified_when)
...
INSERT INTO lesson_history(id, type, timestamp, lesson_id, created_when, modified_when)
VALUES ('c2826cb6-bdea-11ed-afa1-0242ac120002', UPDATED, NOW() - 0.9, '6b4e23aa-bddf-11ed-afa1-0242ac120002', NOW() - 1, NOW() - interval '23 hours');
INSERT INTO lesson_history(id, type, timestamp, lesson_id, created_when, modified_when)
VALUES ('c2826f2c-bdea-11ed-afa1-0242ac120002', CREATED, NOW() - 1, '6b4e24b8-bddf-11ed-afa1-0242ac120002', NOW() - 1, NOW() - interval '1 day');
INSERT INTO lesson_history(id, type, timestamp, lesson_id, created_when, modified_when, cancelled_when)
VALUES ('c28270b2-bdea-11ed-afa1-0242ac120002', CANCELLED, NOW(), '6b4e24b8-bddf-11ed-afa1-0242ac120002', NOW() - 1, NOW(),  NOW());
INSERT INTO lesson_history(id, type, timestamp, lesson_id, created_when, modified_when)
...
INSERT INTO lesson_history(id, type, timestamp, lesson_id, created_when, modified_when, cancelled_when)
VALUES ('c2827832-bdea-11ed-afa1-0242ac120002', CANCELLED, NOW() - 0.1, '6b4e26c0-bddf-11ed-afa1-0242ac120002', NOW() - 0.15, NOW() - 0.1, NOW() - 0.1);
INSERT INTO lesson_history(id, type, timestamp, lesson_id, created_when, modified_when)
...
INSERT INTO lesson_history(id, type, timestamp, lesson_id, created_when, modified_when, cancelled_when)
VALUES ('c2827e7c-bdea-11ed-afa1-0242ac120002', CANCELLED, NOW() - 0.08, '6b4e29b8-bddf-11ed-afa1-0242ac120002', NOW() - 0.2, NOW() - 0.08, NOW() - 0.08);

...
VALUES ('f0e1a34a-bdd3-11ed-afa1-0242ac120002', 'Екатерина', 'Смирнова', '501727035', 'katy@gmail.com', 'katy',  'STUDENT', NOW() - interval '1 hour', NOW() - interval '1 hour');
INSERT INTO Users(id, name, lastname, telegram_id, email, password, role, created_when, modified_when)
VALUES ('f0e1a62e-bdd3-11ed-afa1-0242ac120002', 'Дарья', 'Потомова', '291891029', 'dpotomova@gmail.com', 'potomova0',  'STUDENT', NOW() - interval '1 day', NOW() - interval '1 day');
...
VALUES ('f0e1ad2c-bdd3-11ed-afa1-0242ac120002', 'Валерия', 'Ахматова', '1267829941',  'valah123',  'STUDENT', NOW() - interval '3 days 30 minutes', NOW() - interval '10 minutes');
INSERT INTO Users(id, name, lastname, telegram_id, email, role, created_when, modified_when)
VALUES ('f0e1ad2c-bdd3-11ed-afa1-0242ac120002', 'Иван', 'Ахматов', '56830149', 'ivan@yandex.ru', 'PARENT', NOW() - interval '2 days', NOW() - interval '5 minutes');
INSERT INTO Users(id, name, lastname, telegram_id, email,  role, created_when, modified_when)
VALUES ('f0e1af98-bdd3-11ed-afa1-0242ac120002', 'Пётр', 'Потомов', '139064307', 'potompetr@mail.ru', 'PARENT', NOW() - interval '5 days', NOW());
INSERT INTO Users(id, name, lastname, telegram_id, role, created_when, modified_when)
VALUES ('f0e1b0b0-bdd3-11ed-afa1-0242ac120002', 'Данил', 'Комиссаров', '363133882', 'TEACHER', NOW() - interval '7 hours', NOW() - interval '7 hours');
INSERT INTO Users(id, name, lastname, telegram_id, email, password, role, created_when, modified_when)
VALUES ('f0e1b1be-bdd3-11ed-afa1-0242ac120002', 'Ксения', 'Львова', '111030045', 'kslvova@yandex.ru', 'lvovaK',  'TEACHER', NOW() - interval '1 day 35 minutes', NOW());
INSERT INTO Users(id, name, lastname, telegram_id, email, password, role, created_when, modified_when)
VALUES ('f0e1b2d6-bdd3-11ed-afa1-0242ac120002', 'Наталья', 'Юлина', '789057594', 'yulinan@mail.ru', 'Nyulina',  'ADMIN', NOW() - interval '10 days 15 minutes', NOW() - interval '10 days 15 minutes');

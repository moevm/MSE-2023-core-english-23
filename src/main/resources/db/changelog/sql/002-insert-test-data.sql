...
VALUES ('a1a30abc-bde2-11ed-afa1-0242ac120002', '6b4e231a-bddf-11ed-afa1-0242ac120002', 'ATTENDED', 10, 'Отличное занятие. Ребёнок доволен', 'Домашнее задание: стр.24', NOW() - 1, NOW() - 0.9);
INSERT INTO lesson_info(id, lesson_id, attendance, created_when, modified_when)
...
INSERT INTO lesson_info(id, lesson_id, attendance, score, family_comment, teacher_comment, created_when, modified_when)
VALUES ('a1a30abc-bde2-11ed-afa2-0242ac120002', '6b4ef9b8-bddf-11ed-afa1-0242ac120002', 'ATTENDED', 10, 'Отличное занятие. Ребёнок очень доволен', 'Домашнее задание: отдохнуть)', NOW() - 14, NOW() - 14);
INSERT INTO lesson_info(id, lesson_id, attendance, created_when, modified_when)
